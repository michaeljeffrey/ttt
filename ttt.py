...
def minimax(board_node, ai, depth):
    ...
    if ai:
        ...
        for move in eligible_moves(board_node):
            ...
            (node_move, node_score) = minimax(node, False, depth - 1)

            if node_score + depth > best_score:
                best_move = move
                best_score = node_score + depth
        ...
        for move in eligible_moves(board_node):
            ...
            (node_move, node_score) = minimax(node, True, depth - 1)
